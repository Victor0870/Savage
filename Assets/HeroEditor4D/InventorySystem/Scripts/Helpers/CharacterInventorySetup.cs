...
namespace Assets.HeroEditor4D.InventorySystem.Scripts.Helpers
{
    public class CharacterInventorySetup
    {
        ...
        public static void Setup(Character character, List<Item> equipped)
        {
            ...
            character.EquipmentTags = new List<EquipmentTag>();
                ...
                try
                {
                    ...
                    switch (item.Params.Type)
                    {
                        ...
                        case ItemType.Helmet:
                            ...
                            if (character.EquipmentTags.Contains(EquipmentTag.ShowEars)) character.EquipmentTags.Remove(EquipmentTag.ShowEars);
                            if (character.EquipmentTags.Contains(EquipmentTag.FullHair)) character.EquipmentTags.Remove(EquipmentTag.FullHair);
                            if (entry.Tags.Contains("ShowEars")) character.EquipmentTags.Add(EquipmentTag.ShowEars);
                            if (entry.Tags.Contains("FullHair")) character.EquipmentTags.Add(EquipmentTag.FullHair);
                            break;
                        case ItemType.Vest:
