...
namespace OctoberStudio.UI
{
    public class LobbyWindowBehavior : MonoBehaviour
    {
        ...
        public void OnPlayButtonClicked()
        {
            ...
            // Lay so lan bam Play da luu tru truoc do
            int playCount = PlayerPrefs.GetInt("PlayCount", 0);
            playCount++; // Tang bien dem len 1
            ...
            if (playCount >= 3)
            {
                Debug.Log("Hien thi quang cao sau 5 lan bam Play.");
            ...
            {
                // Neu chua du 5 lan, vao game ngay lap tuc
                GameController.LoadStage();
            }

            PlayerData.Instance.IncreaseEXP();
