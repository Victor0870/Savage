...
namespace OctoberStudio
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //FindObjectOfType<AdManager>().RequestBannerAd(AdPosition.Bottom);
        }
        ...
        private static IEnumerator StageLoadingCoroutine()
        {
            ...
            yield return UnloadAsyncScene("MainMenu");
        ...
        private static IEnumerator MainMenuLoadingCoroutine()
        {
            ...
            yield return LoadAsyncScene("MainMenu", LoadSceneMode.Single);
        }
