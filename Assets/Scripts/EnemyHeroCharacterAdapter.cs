...
/// </summary>
public class EnemyHeroCharacterAdapter : MonoBehaviour, OctoberStudio.ICharacterBehavior
{
    ...
    private Vector2 _currentMovementDirection = Vector2.down; // Mặc định là Down (Front)
